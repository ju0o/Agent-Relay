...
- Verification: `npm run build:server`; `node --test test/v16-slice8-wrapper-qa-mode.test.mjs test/phase-g-dispatcher.test.mjs test/v1-qa-loop.test.mjs` → **PASS totals below**. `LIVE_DATAROOT_WRITES: 0`.
